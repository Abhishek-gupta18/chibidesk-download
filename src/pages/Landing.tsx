...
function Community() {
  const resources = [
    {
      user: "DeskFan42",
      text: "Shared a 4K animated wallpaper pack — 12 files, free for everyone.",
      time: "2 hours ago",
      likes: 34,
    },
    {
      user: "PixelQueen",
      text: "Posted a set of custom widget GIFs you can drop straight into ChibiDesk.",
      time: "5 hours ago",
      likes: 21,
    },
    {
      user: "NeonRig",
      text: "Sharing my neon icon pack — 50 high-res transparent PNGs.",
      time: "1 day ago",
      likes: 48,
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <FadeIn>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white leading-tight">
              Join the Discord.
              <br />
              <span className="text-white/40">Share resources together.</span>
            </h2>
            <p className="mt-5 text-sm text-white/35 leading-relaxed max-w-md">
              Our Discord server is where the community comes together. Share GIFs, wallpapers, icon packs, and custom widgets — or grab something made by another user. It is the go-to place for ChibiDesk resources and setup inspiration.
            </p>
            <div className="mt-4 flex items-center gap-3 text-[11px] font-[JetBrains_Mono] text-white/25">
              <span className="flex items-center gap-1.5">
                <Sparkles className="h-3 w-3 text-[#7C5CFC]/50" />
                Free assets
              </span>
              <span className="flex items-center gap-1.5">
                <MessageCircle className="h-3 w-3 text-[#00D4AA]/50" />
                Direct chat
              </span>
              <span className="flex items-center gap-1.5">
            ...
            <div className="mt-8 flex items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#5865F2] px-5 py-2.5 text-xs font-semibold text-white hover:bg-[#4752C4] transition-colors"
              >
